...
public class CompanyUpdateEmergencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_update_emergency);

        back = findViewById(R.id.back_UpdateEmergency);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(CompanyUpdateEmergencyActivity.this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item,state);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Glide.with(CompanyUpdateEmergencyActivity.this).load(pImage).into(imageView);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.app.AlertDialog dialog = new android.app.AlertDialog.Builder(CompanyUpdateEmergencyActivity.this)
                                ...
                                ref.child(postFID).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(CompanyUpdateEmergencyActivity.this, "Info Has Been Uploaded", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(CompanyUpdateEmergencyActivity.this, CompanyViewEmergencyActivity.class));
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(CompanyUpdateEmergencyActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
    ...
    private void deleteRecord(String postFID) {
        ...
        mTask.addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                startActivity(new Intent(CompanyUpdateEmergencyActivity.this,CompanyViewEmergencyActivity.class));
                Toast.makeText(CompanyUpdateEmergencyActivity.this,"Successfully Deleted",Toast.LENGTH_SHORT).show();
                finish();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CompanyUpdateEmergencyActivity.this,"Not Successfully Deleted",Toast.LENGTH_SHORT).show();
