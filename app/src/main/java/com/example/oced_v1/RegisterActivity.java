...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        company = findViewById(R.id.rbCompany);
    ...
    private void validateData() {
        ...
        }else if (!user.isChecked() && !company.isChecked()){
            Toast.makeText(this, "Choose User or Company...", Toast.LENGTH_SHORT).show();
        }
        else {
            createUserAccount();
        }
        ...
        ref.child(uid)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(RegisterActivity.this, "Details Saved Please Login Again...", Toast.LENGTH_SHORT).show();
