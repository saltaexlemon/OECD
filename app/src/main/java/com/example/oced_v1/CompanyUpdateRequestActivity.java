...
public class CompanyUpdateRequestActivity extends AppCompatActivity {

    Button whatsApp,map,update;
    EditText txtName,txtAddress,txtState,txtContactNumber,txtEmail
            ,txtStatus,txtRemark,txtCompanyEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_update_request);

        back = findViewById(R.id.back_UpdateRequest);
        ...
        txtCompanyEmail = findViewById(R.id.update_etCompanyEmail);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Glide.with(CompanyUpdateRequestActivity.this).load(pImage).into(imageView);
                }
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String ApCompanyEmail = txtCompanyEmail.getText().toString().trim();
                String ApUid = DUid;
                String ApFid = DFId;
                ...
                if (TextUtils.isEmpty(ApStatus)){
                    ...
                    uploadData(ApName,ApAddress,ApContactNumber,ApEmail,ApState,ApStatus,
                            ApRemark,ApUid,ApFid,ApImage,ApStatusUid,ApCompanyEmail);
                }
            }
        });
    ...
    private void uploadData(String apName, String apAddress, String apContactNumber, String apEmail, String apState, String apStatus, String apRemark, String apUid, String apFid, String apImage, String apStatusUid, String apCompanyEmail) {
                                ...
                                ref.child(apFid).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(CompanyUpdateRequestActivity.this, "Request has been Updated", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(CompanyUpdateRequestActivity.this, CompanyViewRequestActivity.class));
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(CompanyUpdateRequestActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
