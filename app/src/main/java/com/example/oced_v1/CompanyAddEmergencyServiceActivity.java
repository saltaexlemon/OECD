...
public class CompanyAddEmergencyServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_add_emergency_service);

        back = findViewById(R.id.back_AddEmergency);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(CompanyAddEmergencyServiceActivity.this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item,state);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(ApName)){
                    ...
                    uploadData(ApName,ApOfficeNumber,ApContactNumber,ApAddress,ApState,ApWorkingDay,ApWorkingHour,ApEmail);
                }
    ...
    private void uploadData(String apName, String apOfficeNumber, String apContactNumber, String apAddress, String apState, String apWorkingDay, String apWorkingHour, String apEmail) {
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(CompanyAddEmergencyServiceActivity.this, "Info Has Been Uploaded", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(CompanyAddEmergencyServiceActivity.this, CompanyViewEmergencyActivity.class));
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(CompanyAddEmergencyServiceActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
