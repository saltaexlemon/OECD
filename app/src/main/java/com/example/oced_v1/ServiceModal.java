...
public class ServiceModal {
    ...
    public ServiceModal(String apFid, String apName, String apOfficeNumber, String apContactNumber, String apAddress, String apState, String apWorkingDay, String apWorkingHour, String apEmail, String apImage) {
        ApFid = apFid;
        ApName = apName;
