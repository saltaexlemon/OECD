...
public class UserServiceDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.back_DetailsService);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(UserServiceDetailsActivity.this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item,state);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Glide.with(UserServiceDetailsActivity.this).load(pImage).into(imageView);
                }
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(UserServiceDetailsActivity.this, "New Request has been submitted", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(UserServiceDetailsActivity.this, UserViewRequestActivity.class));
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(UserServiceDetailsActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
