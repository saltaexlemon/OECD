...
public class UserServiceAdapter extends RecyclerView.Adapter<UserServiceAdapter.MyHolder>{
    ...
    public UserServiceAdapter(Context context, List<EmergencyModel> postModelList) {
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent UserDetailsServicePostActivity = new Intent(context,UserDetailsServicePostActivity.class);
                    int position = getAdapterPosition();

                    UserDetailsServicePostActivity.putExtra("ApFid",postModels.get(position).getApFid());
                    UserDetailsServicePostActivity.putExtra("ApName",postModels.get(position).getApName());
                    UserDetailsServicePostActivity.putExtra("ApImage",postModels.get(position).getApImage());

                    UserDetailsServicePostActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(UserDetailsServicePostActivity);
