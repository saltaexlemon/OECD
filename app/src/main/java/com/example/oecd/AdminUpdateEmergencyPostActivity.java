...
public class AdminUpdateEmergencyPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_update_emergency_post);

        Toolbar toolbar = findViewById(R.id.UpdateEmergencyPageToolbar);
        ...
        delete = findViewById(R.id.update_BtnDelete);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AdminUpdateEmergencyPostActivity.this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item, state);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Glide.with(AdminUpdateEmergencyPostActivity.this).load(pImage).into(imageView);
                ...
                try {
                    ...
                    txtDes.setText(DeApDescription);
                } catch (NullPointerException e) {
                    System.out.println("NullPointerException thrown!");
                }
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.app.AlertDialog dialog = new android.app.AlertDialog.Builder(AdminUpdateEmergencyPostActivity.this)
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(ApName)){
                    ...
                    uploadData(ApName,ApOfficeNumber,ApContactNumber,ApAddress,ApState,ApWorkingDay,ApWorkingHour,ApFid,ApImage,ApDescription);
                }
    ...
    private void uploadData(String apName, String apOfficeNumber, String apContactNumber, String apAddress, String apState,
                            String apWorkingDay, String apWorkingHour, String apDescription,String apFid,String apImage) {
                                ...
                                ref.child(apFid).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(AdminUpdateEmergencyPostActivity.this, "Info Has Been Uploaded", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(AdminUpdateEmergencyPostActivity.this, AdminViewEmergencyActivity.class));
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(AdminUpdateEmergencyPostActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
    ...
    private void deleteRecord(String postFID) {
        ...
        mTask.addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                startActivity(new Intent(AdminUpdateEmergencyPostActivity.this,AdminViewEmergencyActivity.class));
                Toast.makeText(AdminUpdateEmergencyPostActivity.this,"Successfully Deleted",Toast.LENGTH_SHORT).show();
                finish();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AdminUpdateEmergencyPostActivity.this,"Not Successfully Deleted",Toast.LENGTH_SHORT).show();
