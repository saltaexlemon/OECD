...
public class AdminUpdateServicePostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_update_service_post);

        Toolbar toolbar = findViewById(R.id.UpdateServicePageToolbar);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AdminUpdateServicePostActivity.this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item, state);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Glide.with(AdminUpdateServicePostActivity.this).load(pImage).into(imageView);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.app.AlertDialog dialog = new android.app.AlertDialog.Builder(AdminUpdateServicePostActivity.this)
                                ...
                                ref.child(apFid).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(AdminUpdateServicePostActivity.this, "Info Has Been Uploaded", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(AdminUpdateServicePostActivity.this, AdminViewServiceActivity.class));
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(AdminUpdateServicePostActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
    ...
    private void deleteRecord(String postFID) {
        ...
        mTask.addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                startActivity(new Intent(AdminUpdateServicePostActivity.this,AdminViewServiceActivity.class));
                Toast.makeText(AdminUpdateServicePostActivity.this,"Successfully Deleted",Toast.LENGTH_SHORT).show();
                finish();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AdminUpdateServicePostActivity.this,"Not Successfully Deleted",Toast.LENGTH_SHORT).show();
