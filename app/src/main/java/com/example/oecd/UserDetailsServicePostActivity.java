...
public class UserDetailsServicePostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_details_service_post);

        Toolbar toolbar = findViewById(R.id.UserViewServicePageToolbar);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Glide.with(UserDetailsServicePostActivity.this).load(pImage).into(imageView);
                }
