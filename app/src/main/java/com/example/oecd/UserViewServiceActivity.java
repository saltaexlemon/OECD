...
public class UserViewServiceActivity extends AppCompatActivity {
    ...
    UserServiceAdapter serviceAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.UserActualViewServicePageToolbar);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    serviceAdapter = new UserServiceAdapter(getApplicationContext(), postModels);
