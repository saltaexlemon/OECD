...
public class AdminAddServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.AddServicePageToolbar);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AdminAddServiceActivity.this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item,state);
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(AdminAddServiceActivity.this, "Info Has Been Uploaded", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(AdminAddServiceActivity.this, AdminViewServiceActivity.class));
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(AdminAddServiceActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
