...
public class AdminViewEmergencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_emergency);

        Toolbar toolbar = findViewById(R.id.EmergencyPageToolbar);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AdminViewEmergencyActivity.this,AdminAddEmergencyActivity.class));
            }
        });
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AdminViewEmergencyActivity.this, com.google.android.material.R.layout.support_simple_spinner_dropdown_item,state);
    ...
    private void Search(String searchText) {
        ...
        Toast.makeText(AdminViewEmergencyActivity.this, "Searching", Toast.LENGTH_SHORT).show();
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    emergencyAdapter = new EmergencyAdapter(getApplicationContext(), postModels);
